      ...
      <form action={formAction}>
        <div>
          ...
          <input type="text" id="title" name="title" required
                 className="block mt-2 py-1.5 px-2 w-full rounded-md border-0 shadow-sm ring-1 ring-inset ring-gray300" />
        </div>
        <div className="mt-6 ">
        ...
        <div className="mt-6 ">
          ...
          <input type="date" id="dueDate" name="dueDate" min="2020=01-01" max="2099=12-31" required
                 className="block mt-2 py-1.5 px-2 w-full rounded-md border-0 shadow-sm ring-1 ring-inset ring-gray300" />
        </div>
        <SubmitButton />
        {state.error && (<p className="text-sm mt-2 text-red-500"></p>)}
      </form>
    </div>
  );
};
